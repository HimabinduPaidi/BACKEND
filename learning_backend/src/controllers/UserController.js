...
async function updateUserDetails(req, res){
    try {
        ...
        // const updatedUser = await User.findOneAndReplace({_id: req.params.id}, req.body, {new: true});
...
export { registerUser, loginUser, logOut, getUserById, refreshAccessToken, getMyProfile, updateUserDetails };